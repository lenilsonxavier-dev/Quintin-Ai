...
import { loadExternalDict } from "./brain/external_dict";
import { 
  detectarHardware, 
  getNavegadorInfo, 
  verificarWebGPU 
...
const systemPrompt = `You are Quinti, an adorable and helpful English tutor. 
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Load 20,000+ words target dictionary in background seamlessly on mount
    loadExternalDict();
  }, []);
